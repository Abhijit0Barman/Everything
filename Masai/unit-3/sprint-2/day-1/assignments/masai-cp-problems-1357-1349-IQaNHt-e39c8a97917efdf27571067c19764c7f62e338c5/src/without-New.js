...
// Example Usage:
const product1 = productFactory('Product 1', 100);
...
function ProductConstructor(name, price) {
    if (!(this instanceof ProductConstructor)) {
        return new ProductConstructor(name, price);
    }
...
// Example Usage:
const product2 = ProductConstructor('Product 2', 200);
...
// Example Usage:
const product3 = ProductClass('Product 3', 300);
