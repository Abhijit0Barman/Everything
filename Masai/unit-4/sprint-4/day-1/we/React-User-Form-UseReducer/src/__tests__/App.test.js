...
describe("React Form Component Testing", () => {
  ...
  it("should render no users found text initially when there is no users data", () => {
    render(<App />);
  ...
  it("should reset the fields with intitial data once the details are submitted", () => {
    render(<App />);
    let name = screen.getByRole("textbox");
    let gender = screen.getByTestId("gender-select");
    let role = screen.getByTestId("role-select");
